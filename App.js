...
import { StyleSheet, Text, View, Button, Alert, LayoutAnimation, TouchableOpacity,Image  } from "react-native";
...
export default class App extends React.Component {
  ...
  soundFart = async () => {
    ...
    setTimeout(() => {this.setState({poop: require('./assets/poops1.png')})}, 200)
  };
  ...
  startMovement = () => {
    this.getMovement = setInterval(() => this.changePosition(), 500);
  }
